...
import { handleLike, handleWatched } from "../utils/reviewUtils";
    ...
    <>
      {isLoading ? (
        ...
        <div className="bg-primary-400 w-full md:w-[75vw] h-full relative  md:left-[17.5%] pt-10 px-5 shadow-xl">
            <>
              <div className="basic-details bg-secondary-400/15  text-white flex pt-5  w-full items-center md:items-stretch flex-col md:flex-row">
                <div
                  id="poster-wrapper"
                ...
                >
                  <img
                    className="w-full px-4 relative top-[-10%] md:static transition duration-300 hover:brightness-75"
            ...
            <div className= {`flex flex-row p-4 gap-5`} >
              ...
              <Button text="watchlist" active={false} onClick={() => {}}/>
